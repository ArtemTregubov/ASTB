...
Функция ВыполнитьДоставку(ПараметрыЖурнала, ПараметрыДоставки, Вложения) Экспорт
	...
	Если ПараметрыДоставки.ИспользоватьFTPРесурс Тогда
		...
		//АсТБ_Alexey_46794_********************************************************************
		Цель = "ftps://"+ ПараметрыДоставки.Сервер +":"+ Формат(ПараметрыДоставки.Порт, "ЧН=0; ЧГ=0") + ПараметрыДоставки.Каталог;
		//АсТБ_Alexey_46794_********************************************************************
		...
		Попытка
			Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ПолучениеФайловИзИнтернета") Тогда
				...
				//АсТБ_Alexey_46794_********************************************************************
				Прокси = МодульПолучениеФайловИзИнтернетаКлиентСервер.ПолучитьПрокси("ftps");
				//АсТБ_Alexey_46794_********************************************************************
			Иначе
				Прокси = Неопределено;
			КонецЕсли;
