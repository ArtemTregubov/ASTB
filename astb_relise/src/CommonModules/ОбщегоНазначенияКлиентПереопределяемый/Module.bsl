...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	//АСТБ_ALEX_**************************************************************
	//обмен с САП
	Интеграция_САП_Сервер.УдалитьНеполученныеПользователемСообщенияПриЗавершенииРаботы();
	//АСТБ_ALEX_**************************************************************
...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	Если Интеграция_САП_Сервер.ПроверитьНеобходимостьПолученияСообщенийОбОбмене() Тогда
		ПодключитьОбработчикОжидания("ПроверкаНаличияОповещенийПользователю",200,Истина);
	КонецЕсли;
	//обмен САП	
