...
Процедура ПолучитьПрефиксообразующиеРеквизиты(Объекты) Экспорт
	...
	//АСТБ_ALEX_**************************************************************
	//добавляем объекты, где Организация указана в реквизите "Владелец"
	
	//спр. Подразделения 
	НоваяСтрока = Объекты.Добавить();
	НоваяСтрока.Объект 		= Метаданные.Справочники.Подразделения;
	НоваяСтрока.Реквизит 	= "Владелец";
	
	//спр. Сотрудники 
	НоваяСтрока = Объекты.Добавить();
	НоваяСтрока.Объект 		= Метаданные.Справочники.Сотрудники;
	НоваяСтрока.Реквизит 	= "Владелец";
	
	//спр. РабочиеМестаАСТБ 
	НоваяСтрока = Объекты.Добавить();
	НоваяСтрока.Объект 		= Метаданные.Справочники.РабочиеМестаАСТБ;
	НоваяСтрока.Реквизит 	= "Владелец";
	
	//спр. НормыОрганизаций 
	НоваяСтрока = Объекты.Добавить();
	НоваяСтрока.Объект 		= Метаданные.Справочники.НормыВыдачиСИЗ;
	НоваяСтрока.Реквизит 	= "Владелец";
	
	//спр. НоменклатураНормОрганизации 
	НоваяСтрока = Объекты.Добавить();
	НоваяСтрока.Объект 		= Метаданные.Справочники.НоменклатураНормОрганизации;
	НоваяСтрока.Реквизит 	= "Владелец";
	...
	//спр. МВЗ 
	НоваяСтрока = Объекты.Добавить();
	НоваяСтрока.Объект 		= Метаданные.Справочники.МВЗ;
	НоваяСтрока.Реквизит 	= "Владелец";
