...
Процедура ОбъектАвторизацииПриИзмененииНаКлиентеНаСервере(Форма, Объект)
	...
	//АСТБ_ALEXEY_**************************************************************
	Если ЗначениеЗаполнено(Объект.ОбъектАвторизации) И НЕ ПроцедурыРаботыСНормамиСервер.ФизическоеЛицоМожетЯвлятьсяВнешнимПользователем(Объект.ОбъектАвторизации) Тогда
		Объект.ОбъектАвторизации = ПредопределенноеЗначение("Справочник.ФизическиеЛица.ПустаяСсылка");
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = "Выбранное физическое лицо не может быть внешним пользователем.
