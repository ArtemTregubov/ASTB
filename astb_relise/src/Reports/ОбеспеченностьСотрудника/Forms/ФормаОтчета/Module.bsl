...
Процедура ФоновоеЗаданиеЗагрузитьРезультат()
	...
	//АсТБ_Alexey_********************************************************************
	//1-я диаграмма
	//РезультатФормирования.ТабличныйДокумент.Рисунки.D1.Верх
	РезультатФормирования.ТабличныйДокумент.Рисунки.D1.Высота = 40;
	РезультатФормирования.ТабличныйДокумент.Рисунки.D1.Ширина = 240;
	//2-я диаграмма
	РезультатФормирования.ТабличныйДокумент.Рисунки.D2.Верх = РезультатФормирования.ТабличныйДокумент.Рисунки.D1.Верх + РезультатФормирования.ТабличныйДокумент.Рисунки.D1.Высота + 4.6;
	//РезультатФормирования.ТабличныйДокумент.Рисунки.D2.Высота
	РезультатФормирования.ТабличныйДокумент.Рисунки.D2.Ширина = 240;
	//АсТБ_Alexey_********************************************************************
