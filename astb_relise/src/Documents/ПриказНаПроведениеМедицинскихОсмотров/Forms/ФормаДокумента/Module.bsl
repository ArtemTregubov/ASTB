...
&НаКлиенте
Процедура ЗаполнитьПоРабочимМестам(Команда)
...
Процедура ЗаполнитьРабочиеМестаДокумента(ВыбранноеЗначение,ТипЗаполнения)
	...
	Документы.ПриказНаПроведениеМедицинскихОсмотров.ЗаполнитьРабочиеМеста(ТекущийОбъект,ВыбранноеЗначение,ТипЗаполнения);
