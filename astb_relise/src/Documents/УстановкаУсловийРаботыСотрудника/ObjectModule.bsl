...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Документы.УстановкаУсловийРаботыСотрудника.ИнициализироватьДанныеДокумента(Ссылка, ДополнительныеСвойства);
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("СправочникСсылка.Сотрудники") Тогда
		...
		Документы.УстановкаУсловийРаботыСотрудника.ЗаполнитьТабличнуюЧасть(ЭтотОбъект);
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ПроведениеСервер.ПроверитьЗанятыеРабочиеМеста(ЭтотОбъект,Отказ,"УсловияРаботы");
