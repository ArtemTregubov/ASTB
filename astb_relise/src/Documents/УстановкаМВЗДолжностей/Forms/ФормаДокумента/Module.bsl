...
Процедура ЗаполнитьТаблицуДокументаНаСервере()
	...
	Документы.УстановкаМВЗДолжностей.ЗаполнитьТабличнуюЧасть(Объект);
...
Процедура Заполнить(Команда)
	...
	Если Объект.МВЗДолжностей.Количество() > 0 Тогда
...
Процедура ИзменитьФлажкиНаСервере(ЗначениеФлажка)
	...
	ТаблицаДокумента = Документ.МВЗДолжностей.Выгрузить();
	ТаблицаДокумента.ЗаполнитьЗначения(ЗначениеФлажка, "Использовать");
	Документ.МВЗДолжностей.Загрузить(ТаблицаДокумента);
...
&НаСервере
Процедура ЗаполнитьПоВсемДолжностямНаСервере(ВыбранноеМВЗ)
	
	Документы.УстановкаМВЗДолжностей.ЗаполнитьПоВсемДолжностям(Объект,ВыбранноеМВЗ);
	
КонецПроцедуры

&НаКлиенте
Процедура ЗаполнитьПоВсемДолжностям(Команда)
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ЗначениеЗаполнено(ВыбранноеЗначение) Тогда
		...
		ЗаполнитьПоВсемДолжностямНаСервере(ВыбранноеЗначение);
