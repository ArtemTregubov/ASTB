...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	ТекущиеДанные.Вес 							= ПолучитьВесДляЧистки(ТекущиеДанные.Номенклатура);
	
КонецПроцедуры

&НаСервереБезКонтекста
Функция ПолучитьВесДляЧистки(Номенклатура)
	
	Возврат Номенклатура.ВесДляУчетаЧистки;
...
Процедура ЗаполнитьНаСервере()
	...
	Документы.ВозвратИзЧистки.ЗаполнитьПоОстаткам(Объект);
