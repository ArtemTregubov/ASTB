...
Процедура НастроитьЭлементыФормы()
	...
	Иначе
		...
		ЭтаФорма.Элементы.Товары.КоманднаяПанель.ПодчиненныеЭлементы.ТоварыГруппа1.ПодчиненныеЭлементы.ТоварыЗаполнить.Видимость = Ложь;
	КонецЕсли;
...
Процедура ЗаполнитьНаСервере()
	...
	Документы.ОприходованиеНоменклатуры.ЗаполнитьДокументПоОснованию(ТекущийОбъект,ТекущийОбъект.ДокументОснование);
