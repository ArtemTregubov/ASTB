...
Процедура ОткрытьПодключаемоеОборудование(Команда)
	...
	ОткрытьФорму("Справочник.ПодключаемоеОборудование.Форма.ПодключениеИНастройкаОборудования", , ЭтаФорма);
...
Процедура УстановитьДоступность()
	...
	Элементы.ОткрытьПодключаемоеОборудование.Доступность 	= ПолучитьФункциональнуюОпцию("ИспользоватьПодключаемоеОборудование");
	
КонецПроцедуры

&НаКлиенте
Процедура ИспользоватьВендинговоеОборудованиеПриИзменении(Элемент)
...
&НаКлиенте
Процедура РесурсОбменаПриИзменении(Элемент)
...
&НаКлиенте
Процедура РесурсПоУмолчанию(Команда)
	
	УстановитьРесурсПоУмолчанию("\\vending-srv\sync\");
	
КонецПроцедуры

&НаСервере
Процедура УстановитьРесурсПоУмолчанию(РесурсПоУмолчанию)
	
	Константы.ВендингРесурсОбмена.Установить(РесурсПоУмолчанию);
...
&НаКлиенте
Процедура НастройкаПланаОбмена(Команда)
	
	ОткрытьФорму("ПланОбмена.Вендинг.ФормаСписка",,ЭтаФорма);
	
КонецПроцедуры

&НаКлиенте
Процедура ВендингНеЗагружатьРаскладкуПриИзменении(Элемент)
