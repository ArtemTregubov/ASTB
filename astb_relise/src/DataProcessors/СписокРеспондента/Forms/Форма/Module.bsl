...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//АсТБ_Alexey_********************************************************************
	Если НЕ ЗначениеЗаполнено(Параметры.Респондент) Тогда
...
Процедура АрхивАнкет(Команда)
	...
	ОткрытьФорму("Обработка.СписокРеспондента.Форма.АрхивАнкет",Новый Структура("Респондент, ВнешнийПользователь",Объект.Респондент,НЕ ЗначениеЗаполнено(Параметры.Респондент)),ЭтотОбъект);
	//АсТБ_Alexey_********************************************************************
